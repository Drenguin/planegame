...
- (id)init
{
    ...
    // Hello world
    CCLabelTTF *label = [CCLabelTTF labelWithString:@"Fighter Plane" fontName:@"Chalkduster" fontSize:38.0f];
    ...
    CCButton *helloWorldButton = [CCButton buttonWithTitle:@"[ START ]" fontName:@"Courier New" fontSize:24.0f];
